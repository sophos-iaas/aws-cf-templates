...
## Sophos XG Firewall v22.0.1.490 on AWS

This release includes all the features and fixes in v22.0 MR1 (v22.0.1.490).

### AWS Firmware

See the [Sophos XG Firewall v22.0.1.490 release notes](https://community.sophos.com/sophos-xg-firewall/b/blog/posts/sophos-firewall-v22-mr1-is-now-available).

### Template

- Update validation of KeyName to match AWS allowed characters
...
See the [Sophos XG Firewall v21.5.1.261 release notes](https://community.sophos.com/sophos-xg-firewall/b/blog/posts/sophos-firewall-v21-5-mr1-is-now-available).
...
This release includes all the features and fixes in v21.5 GA (v21.5.0.177).

### AWS Firmware

See the [Sophos XG Firewall v21.5.0.177 release notes](https://community.sophos.com/sophos-xg-firewall/b/blog/posts/sophos-firewall-v21-5-is-now-available).
